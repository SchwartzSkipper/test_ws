...
namespace yocs {
  class WaypointProvider {
    ...
    protected:
      ...
      void waypoint_add_sub(const yocs_msgs::Waypoint::ConstPtr& wp);
      void waypoint_remove_sub(const yocs_msgs::Waypoint::ConstPtr& wp);
      void waypoint_revise_sub(const yocs_msgs::Waypoint::ConstPtr& wp);
      void trajectory_add_sub(const yocs_msgs::Trajectory::ConstPtr& traj);
      void trajectory_remove_sub(const yocs_msgs::Trajectory::ConstPtr& traj);
    ...
    private:
      ...
      ros::Subscriber waypoint_revise_sub_;
      ros::Subscriber trajectory_add_sub_;
      ros::Subscriber trajectory_remove_sub_;
